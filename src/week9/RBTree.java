...
public class RBTree extends Tree {
	...
	public static void main(String[] args) {
		...
		Node foundNode = redBlackTree.find(25);
		...
		foundNode = redBlackTree.find(19);
		...
		boolean isDeleted = redBlackTree.delete(25);
		...
		isDeleted = redBlackTree.delete(25);
